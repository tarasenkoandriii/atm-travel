...
export const YOUTUBE_SEED: DiscoveredCamera[] = [
  ...
  { source: 'YOUTUBE', externalId: 'ryyC8t-mxyQ', type: 'YOUTUBE', videoId: 'ryyC8t-mxyQ', title: 'Бурбон-стрит', city: 'Новый Орлеан', country: 'США', cc: 'US', lat: 29.9588, lng: -90.0650, tz: 'America/Chicago', res: 'HD', category: 'tourism', provider: 'earthcam', iata: 'MSY' },
  { source: 'YOUTUBE', externalId: 'rnNPl27Arpk', type: 'YOUTUBE', videoId: 'rnNPl27Arpk', title: 'Балкон над Бурбон-стрит', city: 'Новый Орлеан', country: 'США', cc: 'US', lat: 29.9591, lng: -90.0648, tz: 'America/Chicago', res: 'HD', category: 'tourism', provider: 'earthcam', iata: 'MSY' },
